...
- **Agent-Docker (Step 010–023):** Sicherheitsfundament + read-only Inventar; als OWNER hinter
...
- **Noch kein** Volume-/Network-Remove (vollständiges Deprovisioning), kein Agent-vermittelter Query-Proxy.
